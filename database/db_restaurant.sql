...
CREATE DATABASE IF NOT EXISTS `db_restaurante` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_restaurante`;

-- Volcando estructura para tabla db_restaurante.products
...
-- Volcando estructura para tabla db_restaurante.users
